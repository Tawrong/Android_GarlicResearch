...
public class OnBoarding extends AppCompatActivity {
    ...
    private Button backButton, nextButton, skipButton;
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getItem(0) < 2){
                    ...
                    Intent i = new Intent(OnBoarding.this, Main_page.class);
                    i.putExtra("email_extra_users", getIntent().getStringExtra("email_extra_users"));
                    startActivity(i);
                    finish();
                }
            }
